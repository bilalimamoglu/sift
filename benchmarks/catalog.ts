...
export const benchmarkCases: BenchmarkCase[] = [
  ...
  },
  {
    ...
    title: "npm audit default report with only critical findings",
    description: "Two default-style npm audit vulnerability blocks with critical severity lines.",
    sourceType: "synthetic-derived",
    capturedAt: "2025-01-01",
  ...
  },
  {
    ...
    title: "npm audit default report with mixed critical/high/moderate severities",
    description:
      "Default npm audit report blocks where critical and high findings should be retained while moderate findings are ignored.",
    sourceType: "synthetic-derived",
    capturedAt: "2025-01-01",
    expectedReductionKind: "security-findings",
    expectedSnippets: [
